...
<body>
	...
	<div id="white">
		...
		<?php
			echo '<input type="hidden" id="assigned_dialog" name="dialog_id" value="' . $dialog_id . '"/>';
			echo '<input type="hidden" id="n_paraphrases" name="n_paraphrases" value="' . $n_paraphrases . '"/>'
		?>
		<div id="container">

			<h1 class="title">Instructions</h1>
			<h3 class="guidelines">
				In this experiment you are going to interact with a dialogue system, trying to reach a  <mark class="bold"> specific goal </mark>.  
				<br><br> At <mark class="bold">any time</mark> you can choose to press one of the two buttons:
				<ul>
					<li><mark class="green"> SUCCESSFULLY COMPLETED :</mark> This means the system correctly guided you till the completion of the task</li><br>
					<li><mark class="red"> YOU GOT ME WRONG:</mark> For some reason, the system wasnt' able to assist you completely. <?php 
						if ($EXPTYPE == "BL"){
							echo '<br>Eventually it will be presented the <mark class="bold"> LAST TURN </mark> and asked the <mark class="bold"> ERROR CATEGORY </mark> <br> We help you understanding the problem also <mark class="bold"> providing what the system understood at the marked turn! </mark></li>';

						}else{
							echo '<br>Eventually it will be asked to mark the <mark class="bold"> FIRST </mark> turn where the error was made and the <mark class="bold"> ERROR CATEGORY </mark> <br>When marking a turn we help you understanding the problem also <mark class="bold"> providing what the system understood at each turn! </mark></li>';
						}
				...
				<table id="info_box_2" >
			        		<tr>
			        			<td class="info_infos"> Information </td> 
			        			<td> What  you want </td>
			        		</tr>
			        		<tr>
			        			<td class="info_infos"> You Say </td>
			        			<td class="attention"> <mark class="attention_big"> Exact </mark><br> Value you must communicate </td>
 			        		</tr>
 			        		<tr>
			        			<td class="info_infos"> System understood </td>
			        			<td > <mark class="bold"> WHAT THE SYSTEM UNDERSTOOD SO FAR</mark>. <br> Check these values in order to understand if the system guided you correctly! </td>
 			        		</tr>
 			        		<!-- 
 			        		<tr id="info_spot">
 			        			<td colspan="2" class="info_spot" > You can request values for slots at any time! </td>
 			        		</tr>
 			        		<tr id="info_spot">
 			        			<td colspan="2" class="info_spot" > The system could ask you for <mark class="bold"> additional information </mark>.<br>Provide any valid value or request them</td>
 			        		</tr>
 			        		<tr id="info_spot">
 			        			<td colspan="2" class="info_spot" > You can change the GOAL if the configuration is not plausible.</td>
 			        		</tr>
 			        	-->
			        	</table>
			        	<br>
				 		<br>
			      These are some suggestions for the interaction:
			      <ul>
					<li> In case you don't know value for some information, <mark class="bold">you can ask the available values </mark> the system!</li>
					<br>
					<li> You can <mark class="bold"> change the goal </mark> if the system is not able to provide any result with the current configuration</li>
					<br>
					
										
					<li> While marking the erroneous turn <mark class="bold">  always check the system belief we provide you! </mark></li>
				  </ul>
			...
			<div id="no_button" align="center" class="float-left" style="width: 20%;">
								...
								<div class="button_cont"  onclick="somethingWrong()" ><button class="example_c"> YOU GOT ME <br> <mark class="attention_big"> WRONG! </mark></button> </div>
				</div>
				<div align="center" class="float-left" style="width: 60%;">
				    ...
				    <input type="text" id="message_txt" style="height: 5%; margin-top: 0.4%; width: 105%  "> 
				    <input type="submit"   onclick="sendMessage()" value="Send" id="send" style="width: 25%; height: 5.2%; font-size: 110%; font-weight: bold">

				
				</div>

				<div id="ok_button" align="center" style="width: 20%;" class="float-left">
					<div class="button_cont" align="center"><button class="example_b" onclick="end_f(true)"> SUCCESFULLY <br>  <mark class="attention_big"> COMPLETED! </mark>  </button>  </div>
				</div>
    ...
    function somethingWrong(){
    	if (n_turn_passed > 0){
    		...
    		document.getElementsByClassName("example_b")[0].style.height="0%"
    		document.getElementsByClassName("example_c")[0].style.height="0%"
