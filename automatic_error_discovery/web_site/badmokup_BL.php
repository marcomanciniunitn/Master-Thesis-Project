...
<body>
	...
	<div id="white">
		...
		<div id="goal_form" >
			...
			<h1 class="title">Bad Interaction Example!</h1>
	        <div id="info_box">
			...
			<div id="no_button" align="center" class="float-left" style="width: 20%;">
				...
				<div align="center" class="float-left" style="width: 60%;">
					<form id="submit-form" action="submit.php" method="POST" style="margin-bottom: -.1%;">
						<div id="chat">
								<div class="div_user" id="user_div_0">
									<p class="user"> Hi!</p>
								</div>
								...
								<div class="div_user" id="user_div_1">
								...
								<div class="div_user" id="user_div_2">
									<p class="user">What about the film Coco?</p>
								</div>

								<div class="div_agent">
									<p class="agent">Unfortunately, I couldn't find any movie with title the film coco? Please tell me the movie's title</speak></p>
								</div>

								<div class="div_user" id="user_div_3">
									<p class="user"> Coco</p>
								</div>

								<div class="div_agent">
									<p class="agent">Alright, got that . Is this movie what you were looking for? [1. title: Coco, genre: Animation, director: Lee Unkrich, actor: Anthony Gonzalez, rating: r]. </p>
								</div>

								<div class="div_user" id="user_div_4">
									<p class="user"> Yes! </p>>
								</div>

								<div class="div_agent">
									<p class="agent">Mm-mmh . Which thater's name?</p>
								</div>

								<div class="div_user" id="user_div_5">
									<p class="user"> some cinema in padova</p>>
								</div>

								<div class="div_agent">
									<p class="agent">Unfortunately, I couldn't find any theater with name some cinema in and city padova . Which theater's name?</p>
								</div>
	...
	<script>	
		...
		beliefs[0] = {"movie::actor": "?", "movie::director": "?", "movie::genre": "?", "movie::rating": "?", "movie::title": "?", "screening::date": "?", "screening::time": "?", "theater::chain": "?", "theater::city": "?", "theater::name": "?", "ticket_purchase::customer_name": "?", "ticket_purchase::number_of_kids": "?", "ticket_purchase::number_of_tickets": "?"}

		beliefs[1] = {"movie::actor": "?", "movie::director": "?", "movie::genre": "?", "movie::rating": "?", "movie::title": "?", "screening::date": "?", "screening::time": "?", "theater::chain": "?", "theater::city": "?", "theater::name": "?", "ticket_purchase::customer_name": "?", "ticket_purchase::number_of_kids": "?", "ticket_purchase::number_of_tickets": "?"}

		beliefs[2] = {"movie::actor": "?", "movie::director": "?", "movie::genre": "?", "movie::rating": "?", "movie::title": "the film coco", "screening::date": "?", "screening::time": "?", "theater::chain": "?", "theater::city": "?", "theater::name": "?", "ticket_purchase::customer_name": "?", "ticket_purchase::number_of_kids": "?", "ticket_purchase::number_of_tickets": "?"}

		beliefs[3] = {"movie::actor": "?", "movie::director": "?", "movie::genre": "?", "movie::rating": "?", "movie::title": "Coco", "screening::date": "?", "screening::time": "?", "theater::chain": "?", "theater::city": "?", "theater::name": "?", "ticket_purchase::customer_name": "?", "ticket_purchase::number_of_kids": "?", "ticket_purchase::number_of_tickets": "?"}

		beliefs[4] = {"movie::actor": "?", "movie::director": "?", "movie::genre": "?", "movie::rating": "?", "movie::title": "Coco", "screening::date": "?", "screening::time": "?", "theater::chain": "?", "theater::city": "?", "theater::name": "?", "ticket_purchase::customer_name": "?", "ticket_purchase::number_of_kids": "?", "ticket_purchase::number_of_tickets": "?"}
		

		beliefs[5] = {"movie::actor": "?", "movie::director": "?", "movie::genre": "?", "movie::rating": "?", "movie::title": "Coco", "screening::date": "?", "screening::time": "?", "theater::chain": "?", "theater::city": "padova", "theater::name": "some cinema in", "ticket_purchase::customer_name": "?", "ticket_purchase::number_of_kids": "?", "ticket_purchase::number_of_tickets": "?"}
    ...
    function somethingWrong(){
    	...
    	if (end === false){
	    	...
	    	textareas.forEach(function(item){
	    		console.log(String(item.nodeName))
	    		if (String(item.nodeName)!= "#text"){
	    		...
	    		if (item.classList[0] == ['div_user']){
	    			...
	    			if (baseline){
	    				console.log(t)
	    				console.log(parseInt(textareas.length/2))
	    				if (t != parseInt(textareas.length/2) - 2 && t != parseInt(textareas.length/2) - 1){
